...
export default function Home() {
  return (
    <div>
      ...
      <div className="community m-5 pt-24 pl-24 pr-24 rounded-2xl bg-gradient-to-r from-white to bg-[#FFE1FA] flex flex-col justify-center items-center ">
        <div className="ctop flex flex-col md:flex-row">
          <div className="cleft w-1/2 h-[70%]">
            <img src="/assets/images/comm.png" alt="community_of_girls" className="w-[70%]" />
          </div>


          <div className="cright w-[50%] flex flex-col gap-12">
            ...
            <button className="bg-black text-white inline-block px-7 py-3 w-fit rounded-3xl poly">
              Connect
            </button>
          </div>
      ...
      <div className="consultant m-5 pt-[3rem] pl-[7rem] pr-24 rounded-2xl bg-gradient-to-r flex flex-col justify-center items-center">
        <div className="ctop flex flex-col md:flex-row">
          <div className="cleft flex flex-col gap-12 w-1/2 mt-10">
            ...
            <button className="bg-[#FF00BF] text-white inline-block px-7 py-3 w-fit rounded-3xl poly">
            Explore
            </button>
          </div>


          <div className="cright w-1/2 h-[70%] flex flex-row justify-end">
            <img src="/assets/images/doc.png" alt="community_of_girls" className="w-[60%]" />
          </div>
        </div>
      </div>

      <div className="guidance m-5 pt-24 pl-24 pr-24 rounded-2xl bg-gradient-to-r from-white to bg-[#FFE1FA] flex flex-col justify-center items-center">
        <div className="ctop flex flex-col md:flex-row">
          <div className="cleft w-1/2 h-[70%]">
            <img src="/assets/images/guide.png" alt="community_of_girls" className="w-[80%] bg-blend-difference" />
          </div>
      ...
      <div className="consultant m-5 pt-24 pl-[7rem] pr-24 rounded-2xl bg-gradient-to-r flex flex-col justify-center items-center">
        <div className="ctop flex flex-col md:flex-row">
          <div className="cleft flex flex-col gap-12 w-1/2">
          ...
          <div className="cright w-1/2 h-[70%] flex flex-row justify-end">
            <img src="/assets/images/maitri.webp" alt="community_of_girls" className="w-[65%]" />
          </div>
        </div>
      </div>
      <Footer/>
